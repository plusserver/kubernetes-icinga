...
type SharedInformerFactory interface {
	...
	Icinga() icinga_nexinto_com.Interface
}

func (f *sharedInformerFactory) Icinga() icinga_nexinto_com.Interface {
	return icinga_nexinto_com.New(f, f.namespace, f.tweakListOptions)
}
